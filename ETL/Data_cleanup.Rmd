...
names(human_development)<-c("ctry_id","year","ind_id","ind_value")
```
...
names(substance_abuse)<-c("year","ctry_id","ind_id","ind_value")
```
...
names(social_determinants)<-c("ctry_id","year","ind_id","ind_value")
```
...
names(infect_ctrl_prevent)<-c("year","ctry_id","ind_id","ind_value")
```
...
names(disease)<-c("year","ctry_id","ind_id","ind_value")
```
